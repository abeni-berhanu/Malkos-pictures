...
// Custom TikTok Icon (since it's not always in basic Lucide sets)
...
const Navbar = () => {
  ...
  return (
    ...
    >
      {/* Container for Socials and Floating Divider */}
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* FLOATING DIVIDER: Not full width, thin, and visible */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center group">
          <img
            src="/logo.png"
            alt="Malkos Logo"
            className="h-10 md:h-13 w-auto object-contain transition-transform duration-500 group-hover:scale-105"
          />
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link
            to="/contact"
            className="px-5 py-2 border border-malkos-orange text-malkos-orange text-[9px] uppercase tracking-[0.25em] font-black hover:bg-malkos-orange hover:text-white transition-all duration-500"
          >
            Book Now
          </Link>
        </div>
      ...
      {/* (Mobile Menu Overlay code remains the same as previous) */}
    </nav>
  );
};
